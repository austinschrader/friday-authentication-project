# Pierre's Bakery MVC .NET with MySQL Project

## Description

The .NET Core MVC with MySQL project allows a baker to manager his pastry shop's wonderful creations. He has a many-to-many relationship where he can showcase his confectionary and baking talents. He can also allow public users to visit his site, as the ability to create, edit, update and destroy are protected by authentication.
